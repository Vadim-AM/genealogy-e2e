...
def test_mfa_setup_requires_superadmin(owner_user: AuthUser, tenant_client: Callable[[AuthUser], httpx.Client]) -> None:
...
def test_mfa_setup_returns_secret_and_uri(
...
def test_mfa_setup_409_when_already_configured(
    superadmin_user: AuthUser, tenant_client: Callable[[AuthUser], httpx.Client]
) -> None:
...
def test_mfa_verify_correct_code_returns_ok(
    superadmin_user: AuthUser, tenant_client: Callable[[AuthUser], httpx.Client]
) -> None:
...
def test_mfa_verify_409_without_setup(
    superadmin_user: AuthUser, tenant_client: Callable[[AuthUser], httpx.Client]
) -> None:
...
def test_mfa_status_initial_not_configured(
    superadmin_user: AuthUser, tenant_client: Callable[[AuthUser], httpx.Client]
) -> None:
...
def test_mfa_status_after_verify_is_fresh(
    superadmin_user: AuthUser, tenant_client: Callable[[AuthUser], httpx.Client]
) -> None:
...
def test_recovery_regenerate_returns_10_codes(
    superadmin_user: AuthUser, tenant_client: Callable[[AuthUser], httpx.Client]
) -> None:
...
def test_recovery_count_after_regenerate_is_10(
    superadmin_user: AuthUser, tenant_client: Callable[[AuthUser], httpx.Client]
) -> None:
...
def test_recovery_redeem_consumes_one_code(
    superadmin_user: AuthUser, tenant_client: Callable[[AuthUser], httpx.Client]
) -> None:
...
def test_recovery_regenerate_invalidates_old_codes(
    superadmin_user: AuthUser, tenant_client: Callable[[AuthUser], httpx.Client]
) -> None:
