...
from tests._core.messages import Placeholders, t
...
class TreePage(BasePage):
    ...
    def __init__(self, page: Page):
        ...
        self.orbit_center = self.tree_container.locator(  # no semantic: canvas card, no ARIA
            '[data-testid="orbit-center-card"]'
        )
